...
<body>
    <div class="receipt-container">
        ...
        <table class="grid-table">
            ...
            <tr>
                <td class="grid-label">ನಗರ/ಗ್ರಾಮ</td>
            ...
            <tr>
                ...
                <td class="grid-label">ಸಂಘದ ಸದಸ್ಯತ್ವ<br>ಅಂತ್ಯೋದಯ/ಬಿಪಿಎಲ್ :</td>
                <td class="grid-value">${data.membership || '-'}<br>${data.rationType || '-'}</td>
            </tr>
            <tr>
                <td class="grid-label">ಮನೆ</td>
                <td class="grid-value">ಫ್ಲ್ಯಾಟ್ : ${data.housingInfo || '-'}</td>
                <td class="grid-label">ಜಮೀನು :</td>
                <td class="grid-value">ಇತರೆ ಆಸ್ತಿ : ${data.houseType || '-'}</td>
            </tr>
            <tr>
                <td class="grid-label">ಬಾಡಿಗೆ ಮನೆ</td>
                <td class="grid-value">-</td>
                <td class="grid-label" colspan="2" style="font-weight: normal; color: #000;">${data.landInfo || '1'} ಎಕರೆ - ${data.gunte || '10'} ಗುಂಟೆ</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="grid-label">ವಿದ್ಯಾಭ್ಯಾಸ ಶಾಲೆ/ಕಾಲೇಜು<br>ಮಾಡುತ್ತಿರುವ</td>
            ...
            <tr>
                <td class="grid-label">ಹಿಂದಿನ ತರಗತಿಯಲ್ಲಿ<br>ಪಡೆದ ಅಂಕಗಳು</td>
            ...
            <tr>
                ...
                <td class="grid-label">ಪ್ರವೇಶ ಬಯಸುವ<br>ಕೋಚಿಂಗ್:</td>
