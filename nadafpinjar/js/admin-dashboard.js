...
<body>
    <div class="receipt-container">
        ...
        <!-- Bottom Message (Fixed font-size 11px without negative letter-spacing so Kannada glyphs render cleanly with no overlaps) -->
        <div style="font-weight: bold; color: #b30000; font-size: 11px; padding: 2px 6px; margin-top: 30px; margin-bottom: 4px; white-space: nowrap; text-align: left; box-sizing: border-box;">
