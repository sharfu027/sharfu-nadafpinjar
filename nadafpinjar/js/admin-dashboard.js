...
if (localStorage.getItem('receipts_version') !== 'v28') {
    localStorage.setItem('receipts', JSON.stringify(defaultReceipts));
    localStorage.setItem('receipts_version', 'v28');
}
...
<body>
    <div class="receipt-container">
        ...
        <table class="grid-table">
            ...
            <tr>
                <td class="grid-label">ಉದ್ಯೋಗ(ಗಳ)</td>
                <td class="grid-value">${data.occupation || '-'}</td>
                <td class="grid-label">ತಾಲೂಕ:</td>
                <td class="grid-value">${data.taluk || '-'}</td>
            </tr>
            <tr>
                <td class="grid-label">ಆಧಾರ್ ಸಂ</td>
                <td class="grid-value">${data.aadhar || '-'}</td>
                <td class="grid-label">ಸಂಖ್ಯೆ ನದನ್ಯಸ್ವ,<br>ಅಂತ್ಯೋದಯ/ಬಿಪಿಎಲ್:</td>
            ...
            <tr>
                <td class="grid-label">ಟಡಿಗೆ ಮನೆ</td>
            ...
            <tr>
                ...
                <td class="grid-label">ಮೊಬೈಲ್ಯೋ ಸಂಖ್ಯೆ</td>
                <td class="grid-value">${data.mobile || '-'}</td>
            </tr>
            <tr>
                <td class="grid-label">ವಿದ್ಯಾಭ್ಯಾಸ ಶಾಲೆ/ಕಾಲೇಜಿನ<br>ಮಾಡುತ್ತಿರುವ</td>
                <td class="grid-value">${data.currentSchool || '-'}</td>
                <td class="grid-label">ವಿದ್ಯಾಭ್ಯಾಸ ಮಾಡುತ್ತಿರುವ<br>ತರಗತಿ</td>
                <td class="grid-value">${data.currentClass || '-'}</td>
            </tr>
            <tr>
                <td class="grid-label">ಹಿಂದಿನ ತರಗತಿ ಮೂಲಿ<br>ಪಡೆದ ಅಂಕಗಳು</td>
            ...
            <tr>
                <td class="grid-label">ತರಗತಿಮೂ ವಿಷಯಗಳು :</td>
                <td class="grid-value">${data.classSubjects || '-'}</td>
                <td class="grid-label">ಪ್ರವೇಶ ಬಯಸುವ<br>ಕೋಚಿಂಗ್/ಕೋಚಿಂಗ್</td>
                <td class="grid-value">${data.coaching || '-'}</td>
            </tr>
            <tr>
                <td class="grid-label">ವಿದ್ಯಾರ್ಥಿಯ ಬ್ಯಾಂಕ್<br>ಹೆಸರು</td>
            ...
            <tr>
                ...
                <td class="grid-label">ವಿದ್ಯಾರ್ಥಿಯ ಬ್ಯಾಂಕ್ ಖಾತೆ<br>ಸಂಖ್ಯೆ :</td>
