...
if (localStorage.getItem('receipts_version') !== 'v31') {
    localStorage.setItem('receipts', JSON.stringify(defaultReceipts));
    localStorage.setItem('receipts_version', 'v31');
}
...
async function syncSubmissionsFromDatabase() {
    try {
        const response = await fetch('https://nadafpinjar-production.up.railway.app/api/donations');
            ...
            <tr style="border-top: 2px solid ${themeColor};">
                ...
                <td class="grid-cell" style="width: 35%; border-bottom: none !important; vertical-align: top; padding: 10px 12px;">
                    <div style="text-align: center; width: 180px; margin: 4px auto 0 auto;">
                        ...
                        <div style="font-size: 12px; font-weight: bold; color: #4f1971; margin-top: 2px; line-height: 1.3; white-space: nowrap;">ಶಹಾಬುದ್ದೀನ್ ಸಾಬ್ ನೂರಭಾಷ</div>
                        <div style="font-size: 11px; font-weight: bold; color: #4f1971; line-height: 1.3; white-space: nowrap;">ರಾಜ್ಯ ಕೋಶಾಧಿಕಾರಿ</div>
                        <div style="font-size: 10px; font-weight: bold; color: #4f1971; line-height: 1.3; white-space: nowrap;">ಕರ್ನಾಟಕ ರಾಜ್ಯ ನದಾಫ್ ಪಿಂಜಾರ್ ಸಂಘ (ರಿ)</div>
                    </div>
                </td>
            </tr>
...
<body>
    <div class="receipt-container">
        ...
        <table style="width: 100%; border-collapse: collapse; border: 1.2px solid #b30000; margin-bottom: 2px; background: #fffdeb;">
            <tr>
                <td style="width: 28%; font-size: 9.5px; font-weight: bold; color: #b30000; padding: 2px 4px;"><span style="color: #b30000;">ಅರ್ಜಿ ಸಂಖ್ಯೆ:</span> <span style="color: #000;">${appNumber}</span></td>
                <td style="width: 44%; font-size: 11.5px; font-weight: bold; color: #b30000; text-align: center; padding: 2px 4px; text-decoration: underline;">ಉಚಿತ ಶಿಕ್ಷಣ ಸೌಲಭ್ಯಕ್ಕಾಗಿ ಅರ್ಜಿ 2026-27</td>
                <td style="width: 28%; font-size: 9.5px; font-weight: bold; color: #b30000; text-align: right; padding: 2px 4px;"><span style="color: #b30000;">ಅರ್ಜಿ ದಿನಾಂಕ :</span> <span style="color: #000;">${found.date}</span></td>
            </tr>
        </table>
        ...
        <div style="text-align: center; font-size: 8px; color: #666; margin: 1px 0 3px 0;">00000</div>

        <!-- Signatures & Recommendation Section (Matches media__1783061615598.png 100%) -->
        <div style="border: 1.2px solid #b30000; background: #fff; padding: 6px 10px; font-weight: bold; color: #b30000; font-size: 10px; box-sizing: border-box;">
            <div style="display: flex; justify-content: space-between; border-bottom: 1px solid #b30000; padding-bottom: 6px; margin-bottom: 6px;">
                <div style="width: 50%;">ವಿದ್ಯಾರ್ಥಿಯ ಸಹಿ :</div>
                <div style="width: 50%; text-align: right;">ತಂದೆಯ/ ಪಾಲಕರ ಸಹಿ</div>
            </div>
            ...
            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                <div style="display: flex; flex-direction: column; gap: 6px; width: 60%;">
                    <div style="display: flex; align-items: center; justify-content: space-between; width: 180px;">
                        ...
                        <span style="border: 1.5px solid #b30000; width: 13px; height: 13px; display: inline-block;"></span>
                    </div>
                    <div style="display: flex; align-items: center; justify-content: space-between; width: 180px;">
                ...
                <div style="width: 40%; text-align: right; font-size: 10.5px; font-weight: bold; color: #b30000; padding-top: 15px;">
                    ಶಿಫಾರಸ್ಸು ಮಾಡಲಾಗಿದೆ
                </div>
            </div>
        </div>

        <div style="font-weight: bold; color: #b30000; font-size: 10px; margin-top: 6px;">
            ರಾಜ್ಯ ಶಿಕ್ಷಣ ಸಮಿತಿಯ ವರದಿ :
        </div>
        <div style="font-weight: bold; color: #b30000; font-size: 10px; margin-top: 14px;">
